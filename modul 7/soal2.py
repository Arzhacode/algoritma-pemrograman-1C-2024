...
basket = set()
renang = set()
# set koson g untuk menyimpan nama
...
def siswa_kedua_klub():
    return basket.intersection(renang) #kembalikan irisan antara basket dan renang atau yang ada di keduanya

# Fungsi untuk menampilkan siswa yang hanya mengikuti satu klub
def siswa_satu_klub():
    return basket.symmetric_difference(renang) # symetric untuk mencek setiap salah satu set 
